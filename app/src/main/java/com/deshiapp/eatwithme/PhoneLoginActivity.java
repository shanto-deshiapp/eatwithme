        ...
        if (cancel) {
            ...
            new CountDownTimer(45000, 1000) {
                ...
                public void onFinish() {
                    timer.setText(0 + " s");
                    resendCode.startAnimation(AnimationUtils.loadAnimation(PhoneLoginActivity.this, R.anim.slide_from_right));
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(PhoneLoginActivity.this, VerifiedActivity.class);
                            startActivity(i);
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(PhoneLoginActivity.this, "Invalid Verification Code", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                });
